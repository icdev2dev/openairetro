...
def main(args):
    ...
    if args.ls_assistant != "":
        print(ChatCompletionPhysicsTutor.list())
        return
    
    if args.ad_assistant != "":

        assistant = ChatCompletionPhysicsTutor.create()
        print(assistant.id)

        return

    if args.rm_assistant != "":
        assistants = ChatCompletionPhysicsTutor.list()
        for assistant in assistants:
            ChatCompletionPhysicsTutor.delete(assistant_id=assistant.id)
        return
