...
from core import ThreadTracker, ChatCompletionThread, ChatCompletionMessage, BaseAssistant
...
async def main(current_thread):
    ...
    while True:     
        ...
        assistant_id = BaseAssistant.retrieve(assistant_id=actual_thread.assistant_id)
